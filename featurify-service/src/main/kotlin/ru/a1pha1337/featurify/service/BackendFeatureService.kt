...
class BackendFeatureService(
    ...
    fun get(
        ...
        val feature =
            if (group.isEmpty()) {
                features.findByNamespaceIdAndGroupIdIsNullAndKey(namespaceId, key)
            } else {
                val scope =
                    groups.findByNamespaceIdAndKey(namespaceId, group) ?: throw NotFoundException("Group was not found")
